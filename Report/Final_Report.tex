...
\begin{figure}[H]
	...
	\caption{United States terror Attacks by Attack Type over time by year.}
\end{figure}
...
\\\\
The data shown in \textit{Figure 10} shows the number of attacks over time grouped by the number of people killed globally. 
